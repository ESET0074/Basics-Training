namespace DataStructureDemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Tubple demo");
            Console.WriteLine();
            var student_tuple = (first, second, third);

            
            Console.WriteLine($"ID: {student_tuple.Item1.id}, Name:{student_tuple.Item1.name},Marks:{student_tuple.Item1.marks}");
            Console.WriteLine();
            Console.WriteLine($"ID: {student_tuple.Item2.id}, Name:{student_tuple.Item2.name},Marks:{student_tuple.Item2.marks}");
            Console.WriteLine();
            Console.WriteLine($"ID: {student_tuple.Item3.id}, Name:{student_tuple.Item3.name},Marks:{student_tuple.Item3.marks}");
